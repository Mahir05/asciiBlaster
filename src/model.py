...
class Model:
    ...
    def initialiseGameScreen(self):
        ...
        self.keypresses = 0; self.accuracy = 100
        self.score = 0
        ...
        if not self.gameOver:
            for shape in self.shapes:
                ...
                if shape['y'] > self.screenHeight + 100:
                    #TODO: change this logic to remove shape from screen and new shape
    ...
    def applyLevelSettings(self, level):
        if level=='1':
            ...
            self.numOfShapes = 3; self.charSize = 15
            self.averageShapeSize = 8; self.gravity = 1
        elif level=='2':
...
# Source of slider code: https://github.com/vimichael/Pygame-Tutorials 
